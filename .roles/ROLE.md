...
Roles for keeping FRAMES useful, humane, and honest as a methodology repo. Read
this before using any role file.
...
Use these roles before expanding the catalog or marking a frame pack ready.

| File | Voice | Primary tension |
|---|---|---|
| `parliament/frame-fit-reviewer.md` | Frame Fit Reviewer | Familiar analogy vs. misleading mapping |
| `parliament/audience-transfer-reviewer.md` | Audience Transfer Reviewer | Broad legibility vs. audience-specific assumptions |
...
1. Identify the target situation the frame is meant to clarify.
2. Check the source analogy for familiarity and action cue quality.
