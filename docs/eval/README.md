...
re-entry sequencing, recovery-pause boundary, route-adjustment boundary, and
hard-stop fixtures for relation-aware scoring. It does not change default Rust
search; it defines expected behavior for the opt-in relation report path.
