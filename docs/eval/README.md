...
re-entry sequencing, and hard-stop fixtures for relation-aware scoring. It does
not change default Rust search; it defines expected behavior for the opt-in
relation report path.
