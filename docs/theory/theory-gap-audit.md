...
| Gap | Risk | First Artifact |
|---|---|---|
| Relation-aware ranking | Authority, risk, application-pack filters, ranking fixtures, Rust design, and private metadata tables exist, but relation-aware report output is not implemented. | Add separate relation-aware report path before changing default search. |
...
3. Add a separate relation-aware report path without changing default search.
