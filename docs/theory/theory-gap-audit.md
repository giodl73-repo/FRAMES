...
| Gap | Risk | First Artifact |
|---|---|---|
| Relation-aware ranking | Authority, risk, application-pack filters, ranking fixtures, Rust design, private metadata tables, first relation-aware report output, and a runnable example exist, but broader fixture coverage is still narrow. | Broaden relation fixture coverage before changing default search. |
...
3. Broaden relation-aware fixture coverage without changing default search.
