...
| Relation-aware report path | The crate needs broader relation fixture coverage before relation scoring can affect default search. | Start from `search_with_relations`, `relation_lookup`, and ranking fixtures |
