...
| IF-015 | `RelationQuery`, `RelationSearchReport`, `RelationCandidate`, `FrameIndex::search_with_relations`, relation enums | Relation-aware report lookup with separate suggestions, demotions, hard stops, warnings, and fallbacks. | target |
